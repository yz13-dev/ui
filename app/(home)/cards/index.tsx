...
export function CardsDemo() {
  return (
    <div
      data-slot="demo"
      className="relative flex w-full max-w-none flex-col gap-(--gap) overflow-hidden p-12 pb-0! [--gap:--spacing(8)] 3xl:[--gap:--spacing(8)] min-[1900px]:p-12 min-[1900px]:[--gap:--spacing(10)]! lg:p-6 lg:[--gap:--spacing(6)]"
    >
      <CardsSkeletonRails />
      <div className="relative z-10 mx-auto grid gap-(--gap) **:data-[slot=card]:w-full min-[1400px]:grid-cols-4! min-[1900px]:grid-cols-5! md:max-w-3xl md:grid-cols-2 lg:max-w-none lg:grid-cols-3 *:w-full xl:max-w-[1600px] 2xl:max-w-[1900px]">
      ...
      <div className="absolute inset-x-0 top-0 z-1 h-120 bg-linear-to-b from-transparent via-background to-muted dark:hidden" />
